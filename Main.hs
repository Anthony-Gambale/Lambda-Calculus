...
main = do
    ...
    displayProgram ((replaceProgram . alphaConvertProgram . parseProgram) source)
    displayProgram ((interpretProgram . replaceProgram . alphaConvertProgram . parseProgram) source)
    main
